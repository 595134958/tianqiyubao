...
public class Utility {// 解析服务器返回的数据的工具类
	...
	public static void handleWeatherResponse(Context context, String response) {
		try {
			...
			String cityName = weatherInfo.getString("city");// 县名称
			String weatherCode = weatherInfo.getString("cityid");
			String temp1 = weatherInfo.getString("temp1");// 最高温度
			String temp2 = weatherInfo.getString("temp2");// 最低温度
			String weatherDesp = weatherInfo.getString("weather");// 天气描述
			String publishTime = weatherInfo.getString("ptime");// 发布时间
	...
	/**
	 * 将JSON解析后的天气信息存储到SharedPreferences文件中
	 */
	private static void saveWeatherInfo(Context context, String cityName,
		...
		editor.putString("current_date", sdf.format(new Date()));//将当前时间存储
		editor.commit();
	}
}
